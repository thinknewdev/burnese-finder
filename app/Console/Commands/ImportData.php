    ...
    private function importDogs(string $path): void
    {
        ...
        while (($row = fgetcsv($handle)) !== false) {
            ...
            Dog::updateOrCreate(
                ['bg_dog_id' => $bgDogId],
                [
                    'registered_name' => $data['registered_name'] ?? $data['dog name'] ?? $data['name'] ?? null,
                    'call_name' => $data['call_name'] ?? $data['call name'] ?? null,
                    'sex' => $data['sex'] ?? null,
                    'birth_date' => $this->parseDate($data['birth_date'] ?? $data['whelp date'] ?? null),
                    'death_date' => $this->parseDate($data['death_date'] ?? null),
                    'age_years' => !empty($data['age_at_death_years']) ? (int)$data['age_at_death_years'] : (!empty($data['age_years']) ? (int)$data['age_years'] : null),
                    'color' => $data['color'] ?? $data['coat_color'] ?? null,
                    'breeder_id' => $breederId,
                    'breeder_name' => $data['breeder_name'] ?? null,
                    'hip_rating' => $data['hip_rating'] ?? null,
                    'elbow_rating' => $data['elbow_rating'] ?? null,
                    'heart_status' => $data['heart_status'] ?? $data['heart_rating'] ?? null,
                    'eye_status' => $data['eye_status'] ?? $data['eye_rating'] ?? null,
                    ...
                    'sire_name' => $data['sire_name'] ?? $data['sire'] ?? null,
                    'dam_name' => $data['dam_name'] ?? $data['dam'] ?? null,
                    'primary_image' => $this->convertImagePath($data['primary_image'] ?? null),
                    // New fields
                    'registration_number' => $data['registration_number'] ?? $data['registrations'] ?? null,
                    'dna_number' => $data['dna_number'] ?? $data['dna reg '] ?? $data['dna reg'] ?? null,
                    ...
                    'dm_status' => $data['dm_status'] ?? null,
                    'stud_book' => $data['stud book'] ?? $data['stud_book'] ?? null,
                    'frozen_semen' => !empty($data['frozen semen']) && strtolower($data['frozen semen']) !== 'false' && $data['frozen semen'] !== 'No',
                    'rescue_type' => $data['rescue type'] ?? $data['rescue_type'] ?? null,
                    'litter_id' => $data['litter id'] ?? $data['litter_id'] ?? null,
                ]
            );
            $count++;
            $bar->advance();
